...
;M665 R150 L350.7 B150 H530                              ; ARTEMIS Injection Molded ARMS 350MM L
...
;M558 P5 I1 A4 R0.4 C"!^zprobe.in" H10 F2500 T6000        ; FSR PROBE set Z probe type to switch and the dive height + speeds
...
M579 X1.0040 Y1.0040 Z1.0040                            ; scale all three SAME amount - for injection molded arms try 1.0100