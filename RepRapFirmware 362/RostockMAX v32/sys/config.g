; SeeMeCNC 3D Printer Config 
; MAY 2026 v3.6.2+1 Duet Firmware
; Optimized for SeeMeCNC factory Orca Slicer software
; ***important*** M92 Steps/mm on all axis extruders must be calibrated manually
;
; General Settings
G90                                 ; absolute coordinates
M83                                 ; relative extruder moves
M550 P"RostockMAXv32"               ; set printer name
...
; User Set Global M665 Variables
global deltaRadius = 142.5        ; Horizontal radius (R)
global armLength = 291.5          ; Diagonal rod length (L)
global bedRadius = 145            ; Printable bed radius (B)
global homedHeight = 400          ; Homed height (H)
...
; Network & Comms
;M540 PF0:E1:D2:C4:11:11	                             ; Ethernet Only -> set unique MAC Address for each SeeMeCNC printer
...
M566 X3000.00 Y3000.00 Z3000.00 E5000.00:5000.00        ; set maximum instantaneous speed changes (mm/min) aka Jerk
M203 X14000.00 Y14000.00 Z14000.00 E9000.00:9000.00     ; set maximum speeds (mm/min)
M201 X3000.00 Y3000.00 Z3000.00 E9000.00:9000.00        ; set accelerations (mm/s^2)
...
T0                                                      ; select Tool 0
M911 S11.0 R11.2 P"M913 X0 Y0 G91 M83 G1 Z3 E-5 F1000"  ; set voltage thresholds and actions to run on power loss
