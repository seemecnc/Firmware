...
M550 P"BOSSdelta500"                ; set printer name
...
global deltaRadius = 260            ; Horizontal radius (R) 160=CF arms and SMC carriages;  155=CF Arms and Linear Rails;  150=CF Arms and Linear Rails
global armLength = 574.2            ; Diagonal rod length (L) BOSS 500 CF ARMS
global bedRadius = 260              ; Printable bed radius (B)
global homedHeight = 1110           ; Homed height (H) Model 0505=600 0510=1100 0521=2200
...
M906 X1700 Y1700 Z1700 E1600:1600 I30                   ; set motor currents (mA) and motor idle factor in per cent
