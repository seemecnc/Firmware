...
; OCT 2025
; Configured for RepRapFirmware v3.5.4+ (current factory release v3.6.1)
; This release is tailored for Orca Slicer Software. 
; ***important*** Line M92 Steps/mm on all axis must be calibrated manually.
;
; General Settings
G90                                 ; absolute coordinates
M83                                 ; relative extruder moves
M550 P"BOSSdelta500"                ; set printer name (ARTEMIS, RostockMAX, BOSSdelta, SeeMeCNC, BestFriend, etc.)
...
global deltaRadius = 260            ; Horizontal radius (R)
global armLength = 574.2            ; Diagonal rod length (L)
