; bed.g for 500mm bed size SeeMeCNC 3D Printers
; updated May 13 2025
; called by G32 for 6-factor auto calibration with global variables
; 
; *** M92 CONFIG.g X Y Z AXIS MUST BE CALIBRATED FOR PROPER STEPS/MM OF MOVEMENT ***
;
G28                                         ; Home
...
G30 P0 X0.00 Y235.00 Z-99999 H0             ; Near Z tower
G30 P1 X-203.52 Y-117.5 Z-99999 H0          ; Near X tower
G30 P2 X203.52 Y-117.5 Z-99999 H0           ; Near Y tower
G30 P3 X203.52 Y117.5 Z-99999 H0            ; Mid Y-Z
G30 P4 X-203.52 Y117.5 Z-99999 H0           ; Mid X-Z
G30 P5 X0 Y-235 Z-99999 H0                  ; Mid X-Y
