...
#if UI_LANGUAGE==1000
// Undefine anything that changes from the default in order to prevent
// redefinition warning.
#undef UI_TEXT_ACCELERATION
#undef UI_TEXT_ACTION_EPOSITION_FAST2
#undef UI_TEXT_ACTION_FANSPEED
#undef UI_TEXT_ACTION_XPOSITION2
#undef UI_TEXT_ACTION_XPOSITION4
#undef UI_TEXT_ACTION_XPOSITION_FAST2
#undef UI_TEXT_ACTION_XPOSITION_FAST4
#undef UI_TEXT_ACTION_YPOSITION2
#undef UI_TEXT_ACTION_YPOSITION4
#undef UI_TEXT_ACTION_YPOSITION_FAST2
#undef UI_TEXT_ACTION_YPOSITION_FAST4
#undef UI_TEXT_ACTION_ZPOSITION2
#undef UI_TEXT_ACTION_ZPOSITION4
#undef UI_TEXT_ACTION_ZPOSITION_FAST2
#undef UI_TEXT_ACTION_ZPOSITION_FAST4
#undef UI_TEXT_ADJTEMPS
#undef UI_TEXT_ANTI_OOZE
#undef UI_TEXT_AUTOLEVEL_FULL
#undef UI_TEXT_BACK
#undef UI_TEXT_BAUDRATE
#undef UI_TEXT_BED_TEMP
#undef UI_TEXT_CONFIGURATION
#undef UI_TEXT_CONTINUE_PRINT
#undef UI_TEXT_COOLDOWN
#undef UI_TEXT_DBG_DRYRUN
#undef UI_TEXT_DBG_ECHO
#undef UI_TEXT_DBG_ERROR
#undef UI_TEXT_DBG_INFO
#undef UI_TEXT_DEBUGGING
#undef UI_TEXT_DELETE_FILE
#undef UI_TEXT_DISABLE_STEPPER
#undef UI_TEXT_EEPROM_LOADED
#undef UI_TEXT_EEPROM_STORED
#undef UI_TEXT_E_POSITION
#undef UI_TEXT_ERROR
#undef UI_TEXT_EXTR0_OFF
#undef UI_TEXT_EXTR0_SELECT
#undef UI_TEXT_EXTR0_TEMP
#undef UI_TEXT_EXTR1_OFF
#undef UI_TEXT_EXTR1_SELECT
#undef UI_TEXT_EXTR1_TEMP
#undef UI_TEXT_EXTR2_OFF
#undef UI_TEXT_EXTR2_SELECT
#undef UI_TEXT_EXTR2_TEMP
#undef UI_TEXT_EXTR_ACCEL
#undef UI_TEXT_EXTR_ADVANCE_K
#undef UI_TEXT_EXTR_ADVANCE_L
#undef UI_TEXT_EXTR_DGAIN
#undef UI_TEXT_EXTR_DMAX
#undef UI_TEXT_EXTR_DMIN
#undef UI_TEXT_EXTR_IGAIN
#undef UI_TEXT_EXTR_MANAGER
#undef UI_TEXT_EXTR_MAX_FEED
#undef UI_TEXT_EXTR_ORIGIN
#undef UI_TEXT_EXTR_PGAIN
#undef UI_TEXT_EXTR_PMAX
#undef UI_TEXT_EXTR_START_FEED
#undef UI_TEXT_EXTR_STEPS
#undef UI_TEXT_EXTRUDER
#undef UI_TEXT_EXTR_WAIT_RETRACT_TEMP
#undef UI_TEXT_EXTR_WAIT_RETRACT_UNITS
#undef UI_TEXT_EXTR_WATCH
#undef UI_TEXT_EXTR_XOFF
#undef UI_TEXT_EXTR_YOFF
#undef UI_TEXT_FAN_25
#undef UI_TEXT_FAN_50
#undef UI_TEXT_FAN_75
#undef UI_TEXT_FAN_FULL
#undef UI_TEXT_FAN_OFF
#undef UI_TEXT_FANSPEED
#undef UI_TEXT_FEED_HOME_X
#undef UI_TEXT_FEED_HOME_Y
#undef UI_TEXT_FEED_HOME_Z
#undef UI_TEXT_FEED_HOME_Z_DELTA
#undef UI_TEXT_FEED_MAX_X
#undef UI_TEXT_FEED_MAX_Y
#undef UI_TEXT_FEED_MAX_Z
#undef UI_TEXT_FEED_MAX_Z_DELTA
#undef UI_TEXT_FEEDRATE
#undef UI_TEXT_FLOW_MULTIPLY
#undef UI_TEXT_GENERAL
#undef UI_TEXT_HEATING_BED
#undef UI_TEXT_HEATING_EXTRUDER
#undef UI_TEXT_HOME_ALL
#undef UI_TEXT_HOME_X
#undef UI_TEXT_HOME_Y
#undef UI_TEXT_HOME_Z
#undef UI_TEXT_IDLE
#undef UI_TEXT_JERK
#undef UI_TEXT_KILLED
#undef UI_TEXT_LOAD_EEPROM
#undef UI_TEXT_MOUNT_CARD
#undef UI_TEXT_MOVE_X
#undef UI_TEXT_MOVE_Y
#undef UI_TEXT_MOVE_Z
#undef UI_TEXT_MOVE_Z_DELTA
#undef UI_TEXT_NA
#undef UI_TEXT_NO
#undef UI_TEXT_NOSDCARD
#undef UI_TEXT_NOSEL
#undef UI_TEXT_OFF
#undef UI_TEXT_ON
#undef UI_TEXT_OPS_BACKSLASH
#undef UI_TEXT_OPS_CLASSIC
#undef UI_TEXT_OPS_FAST
#undef UI_TEXT_OPS_MINDIST
#undef UI_TEXT_OPS_MOVE_AFTER
#undef UI_TEXT_OPS_OFF
#undef UI_TEXT_OPS_RETRACT
#undef UI_TEXT_PAGE_BED
#undef UI_TEXT_PAGE_BUFFER
#undef UI_TEXT_PAGE_EXTRUDER
#undef UI_TEXT_PAGE_EXTRUDER1
#undef UI_TEXT_PAGE_EXTRUDER2
#undef UI_TEXT_PAGE_EXTRUDER3
#undef UI_TEXT_PAUSE_PRINT
#undef UI_TEXT_POSITION
#undef UI_TEXT_POWER
#undef UI_TEXT_POWER_INACTIVE
#undef UI_TEXT_POWER_INACTIVE2
#undef UI_TEXT_PREHEAT_ABS
#undef UI_TEXT_PREHEAT_PLA
#undef UI_TEXT_PRINTED
#undef UI_TEXT_PRINTER_READY
#undef UI_TEXT_PRINT_FILAMENT
#undef UI_TEXT_PRINT_FILE
#undef UI_TEXT_PRINTING
#undef UI_TEXT_PRINT_POS
#undef UI_TEXT_PRINT_TIME
#undef UI_TEXT_PRINTTIME_DAYS
#undef UI_TEXT_PRINTTIME_HOURS
#undef UI_TEXT_PRINTTIME_MINUTES
#undef UI_TEXT_PRINT_X
#undef UI_TEXT_PRINT_Y
#undef UI_TEXT_PRINT_Z
#undef UI_TEXT_PRINT_Z_DELTA
#undef UI_TEXT_QUICK_SETTINGS
#undef UI_TEXT_SD_CARD
#undef UI_TEXT_SEL
#undef UI_TEXT_SET_TO_ORIGIN
#undef UI_TEXT_SPEED_MULTIPLY
#undef UI_TEXT_STEPPER_DISABLED
#undef UI_TEXT_STEPPER_INACTIVE
#undef UI_TEXT_STEPPER_INACTIVE2
#undef UI_TEXT_STOP_PRINT
#undef UI_TEXT_STORE_TO_EEPROM
#undef UI_TEXT_STRING_ACTION
#undef UI_TEXT_STRING_HM_BANGBANG
#undef UI_TEXT_STRING_HM_DEADTIME
#undef UI_TEXT_STRING_HM_PID
#undef UI_TEXT_STRING_HM_SLOWBANG
#undef UI_TEXT_UNMOUNT_CARD
#undef UI_TEXT_UPLOADING
#undef UI_TEXT_X_POS_FAST
#undef UI_TEXT_X_POSITION
#undef UI_TEXT_YES
#undef UI_TEXT_Y_POS_FAST
#undef UI_TEXT_Y_POSITION
#undef UI_TEXT_ZJERK
#undef UI_TEXT_Z_POS_FAST
#undef UI_TEXT_Z_POSITION
